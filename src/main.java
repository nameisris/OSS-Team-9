...
>>>>>>> 988d90b8622189d12fe9360f1d54ac615b1e5ac4
...
//		
//		String path = "C:\\ExcelExport";
//		String[] dataArr = {"1", "3"};
//		we.getExcel(path, dataArr);
		gwp.start();
	...
	public void run() {
		try {
		    ...
		    while(j < 10) {
			    ...
			    list.add(tabName);
			    list.add(simple_format.format(date_now));
			...
			//Excel 파일 저장을 위한 객체생성
			WriteExcel we = new WriteExcel();
			
		    we.getExcel("qwe", list);
